...
const NotificationsSection = ({ user, updateUser }) => {
  ...
  const toggleItems = [
    ...
    { key: 'registrationAlerts', label: 'Registration Alerts', desc: 'Get notified when someone registers for your events' },
  ...
  return (
    <div className="space-y-1">
      {toggleItems.map(({ key, label, desc }) => (
        <div key={key} className="flex items-center justify-between p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
          <div>
          ...
          <button
            ...
            className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 ${preferences[key] ? 'bg-primary-600' : 'bg-gray-200 dark:bg-gray-700'}`}
          >
